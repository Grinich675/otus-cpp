...
/**
  \ingroup Serializers
 \brief Class of SWF serialization format
 \details
 Class contains logic for serializing and deserializing vector object primitives to\from SWF format
 \warning not Implemented.
 */
class SWFSerializer: public Serializer
{
	std::fstream file;
	std::string filename;
...
public:
		...
		SWFSerializer(std::string&& _filename):
			filename(_filename)
		{};
